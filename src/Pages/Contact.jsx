...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formSubmitUrl = 'https://formsubmit.co/willamhuamansaavedra13@gmail.com';
      ...
      submitData.append('_subject', 'Nuevo mensaje desde el portafolio web');
      ...
      if (error.request && error.request.status === 0) {
        Swal.fire({
          title: 'Mensaje posiblemente enviado!',
          text: 'No se recibió confirmación del servidor, pero tu mensaje podría haber sido entregado!',
          icon: 'success',
          confirmButtonColor: '#6366f1',
          timer: 2000,
          timerProgressBar: true
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Estoy abierto a oportunidades profesionales, colaboraciones y desafíos. Déjame tu mensaje y te responderé pronto.
        </p>
      </div>
          ...
          >
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  ¿Tienes algo que quisieras conversar? Envíame un mensaje y estaré encantado de responderte.
                </p>
              </div>
            ...
            >
              ...
              >
                ...
                {isSubmitting ? 'Mengirim...' : 'Enviar mensaje'}
              </button>
            </form>
