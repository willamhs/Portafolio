    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             Soy estudiante de Ciencias de la Computación con interés en ciberseguridad, ciencia de datos, IA y desarrollo web. Domino Python, Java, SQL, C#, C++ y herramientas como Power BI, Excel. Me destaco por mi análisis y compromiso con la tecnología.
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "No programo solo para que el código funcione, programo para que algo cambie."
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/drive/folders/1VSxRyymJ8QPwTxBOhzVK4R-liJa_CRzH?usp=drive_link" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
